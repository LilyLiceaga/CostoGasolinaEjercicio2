package com.example.costogasolinaejercicio2
...
import com.example.costogasolinaejercicio2.ui.theme.CostoGasolinaEjercicio2Theme
...
fun CostGasLayout() {
    ...
    val total = CalcularMonto(precioLitro,cantLitros, boolPropina = boolPropina, propina = propina)
    ...
    Column (
        ...
        EditNumberField(
            ...
            leadingIcon = R.drawable.baseline_18_up_rating_24,
            keyboardsOptions = KeyboardOptions.Default.copy(
                keyboardType = KeyboardType.Number,
        ...
        AddTip(
            boolPropina = boolPropina,
            onTipCheckedChange = { boolPropina = it }
        )
...
private fun CalcularMonto(precio: Double, cantLitros: Double, boolPropina: Boolean, propina: Double): String{
